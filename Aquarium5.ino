...
// --- day ---
#define firstDayHour 8 // Hour for day(255) start
// --- sunset start ---
#define firstSunsetHour 12 // Hour for sunset(255->0) start
// --- day pause start ---
#define dayPauseHour 13 // Hour for daypause(0) start
// --- second sunrise start --
#define secondSunriseHour 16 //Hour for sunrise (0->255) start
// --- second day ---
#define secondDayHour 17 // Hour for day(255) start
// --- second sunset start ---
